...
Many of the lower-income cities and countries have data on waste composition which is more than 10 years old and may not adequately reflect current consumption patterns, for example, consumption of plastic packaging and electronic equipment(Comparative analysis). This presents a big challene in the data analysis field
...
With the spatial-temporal variations and expexted increases in solid waste generation, its management requires all relevant stake holders to be on board from producers to consumers and all the institutions(Global waste management outlook).
